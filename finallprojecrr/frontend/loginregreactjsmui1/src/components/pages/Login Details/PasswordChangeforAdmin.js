...
export default function PasswordChange() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8080/Admin/Controller/getadminbyemail/${userEmail}`)
      .then((res) => {
  ...
  function formHandle(e) {
    ...
    e.preventDefault();
    axios
      .put("http://localhost:8080/Admin/Controller/updateAdminpass", userData)
      .then((res) => {
      ...
      window.location.href="/PasswordChangeLogin"
  })
  }
  return (
