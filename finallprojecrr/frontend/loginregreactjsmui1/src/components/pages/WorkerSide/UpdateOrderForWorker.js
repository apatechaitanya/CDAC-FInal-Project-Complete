...
//   const [cust_id, setCust_id] = useState("");
  ...
  const saveOrUpdateEmployee = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        window.location.href = "/ViewAllOrdersForWorker";
  ...
  return (
    <div className="AddCust" style={{border:"10px solid grey" ,margintop:"50px", height:"650px"}}>
      <br />
      <br />
          ...
          <div className="card col-md-6 offset-md-3 offset-md-3">
            ...
            <div className="card-body">
              <form>
                ...
                <Link to="/ViewAllOrdersForWorker" className="btn btn-danger">
                  {" "}
                  Cancel{" "}
                </Link>
              </form>
...
export default UpdateOrderForWorker;
